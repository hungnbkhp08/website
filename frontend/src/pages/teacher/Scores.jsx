...
const TeacherScores = () => {
  ...
  const openForm = (scoreItem = null) => {
    if (scoreItem) {
      ...
      setForm({ id: null, student_id: students.length > 0 ? students[0].id : '', subject: '', exam_type: 'Giữa kỳ', semester: 'Học kỳ 1', score: '', note: '' });
    }
    setModalOpen(true);
  };
  ...
  const deleteScore = async (id) => {
    ...
    try {
      ...
      loadScores();
    } catch (err) { alert(err.response?.data?.error || 'Lỗi xóa điểm'); }
  };
        ...
        <div className="card-body">
          {loading ? (
            ...
            <div className="table-wrapper">
              <table>
                <thead><tr><th>Học sinh</th><th>Môn học</th><th>Kỳ thi</th><th>Học kỳ</th><th>Điểm</th><th>Ghi chú</th><th>Thao tác</th></tr></thead>
                <tbody>
